                ...
                lib.generator =
                    {
                        ...
                        let
                            pkgs = builtins.trace "STASH_FACTORY 2" ( primary.nixpkgs.legacyPackages.${ primary.system } ) ;
                            primary =
                                {
                                    factory-name =
                                        visitor.lib.${ system }
                                    ...
                                    nixpkgs =
                                        visitor.lib.${ system }
                                            {
                                                set = path : set : builtins.trace "stash-factory.nixpkgs" set ;
                                                string = path : value : builtins.throw "CAUGHT STRING ${ value }" ;
                                            }
                                        nixpkgs ;
                                    path =
                                        visitor.lib.${ system }
                            ...
                            in
                                builtins.trace "pkgs.writeShellApplicati0n" (
                                            ...
                                            let
                                                ...
                                                x =
                                                    ''
                                                        ...
                                                        HASH="$( echo "$TIMESTAMP" "$@" "$HAS_STANDARD_INPUT" "$( cat "$STANDARD_INPUT" )" | sha512sum | cut -c1-${ builtins.trace primary.hash-length primary.hash-length } )"
